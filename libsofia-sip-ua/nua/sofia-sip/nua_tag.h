...
#define NUTAG_IGNORE_ACK(x)   NUTAG_IGNORE_ACK, tag_bool_v(x)
SOFIAPUBVAR tag_typedef_t NUTAG_IGNORE_ACK;
#define NUTAG_IGNORE_ACK_REF(x) NUTAG_IGNORE_ACK_ref, tag_bool_vr(&(x))
SOFIAPUBVAR tag_typedef_t NUTAG_IGNORE_ACK_ref;
//UC //end by liangjie for DS-84208,2020.5.26
SOFIA_END_DECLS
